...
The engine behind FelineTrace analyzes the currently loaded dossier. It does not replay fixture results or read `source-docs/data-ground-truth`.
...
- `POST /api/load-final`
- `POST /api/select` to select a preset and run the requested specialists atomically
