...
import { PublicChecks } from './PublicChecks'
import { PublicSourceDrawer } from './PublicSourceDrawer'
...
function App() {
  ...
  const [selectedPublicResult, setSelectedPublicResult] = useState<PublicCheckResult | null>(null)
  ...
  return (
    <div className="simple-app">
      ...
      <main className="workspace">
        <section className="document-workspace">
          ...
          <PublicChecks
            ...
            onOpenResult={setSelectedPublicResult}
            onReplayComplete={() => notify('Replay complete · sample data')}
          />
      ...
      {selectedPublicResult && (
        <PublicSourceDrawer
          result={selectedPublicResult}
          onClose={() => setSelectedPublicResult(null)}
          onCopied={() => notify('Provenance copied')}
        />
      )}
