    ...
    <div className="simple-app">
      <header className="simple-header">
        ...
        <div className="document-title">
          <strong>Muster Verpackungen · Benchmark studio</strong>
          <span>Saved</span>
        </div>
        <div className="header-actions">
          ...
          <button
            ...
            onClick={() => {
              ...
              notify('4 detectors agree on 4 findings')
            }}
          >
            <RefreshCw size={14} /> Run ensemble
          </button>
        </div>
      </header>
      ...
      <main className="workspace">
        <section className="document-workspace">
          <div className="document-status-bar">
            ...
            <button type="button" onClick={() => notify('Rules · Graph · Sequence · Skeptic')}><ShieldCheck size={13} /> 4 methods</button>
          </div>
          ...
          <MethodStudio
            ...
            onAdd={(draft) => {
              setManualCases((items) => [...items, { ...draft, id: Date.now() }])
              notify('Linked case added')
            }}
          />
