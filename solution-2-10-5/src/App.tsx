...
import { buildReportValue, loadAnalysis, rerunAnalysis, runSpecialists } from './analysis'
...
export default function App() {
  ...
  useEffect(() => {
    void loadAnalysis().then(setAnalysis).catch((reason) => setError(reason instanceof Error ? reason.message : 'Audit engine unavailable')).finally(() => setLoading(false))
  }, [])
  ...
  return <div className="simple-app">
    <header className="simple-header">
      ...
      <div className="header-actions">
        {view === 'report' && <button type="button" className="quiet-button source-data-button" onClick={() => setSourceDialogOpen(true)}><DatabaseZap size={15} /> Edit source data</button>}
